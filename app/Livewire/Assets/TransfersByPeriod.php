...
class TransfersByPeriod extends Component
{
    ...
    {
        return view('livewire.assets.reports.transfers-by-period', [
    ...
    {
        return $this->assetsReportService->transfersByPeriod([
