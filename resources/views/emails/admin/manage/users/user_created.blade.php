                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff; border-radius:10px; box-shadow:0 2px 8px rgba(0,0,0,0.08); overflow:hidden;">
                    ...
                    <tr>
                        <td align="center" style="background-color:#2563eb; padding:24px;">
                            <h1 style="color:#ffffff; font-size:22px; margin:0; font-weight:600;">Bem-vindo(a), {{ $user->name }}!</h1>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:32px 40px;">
                            <p style="font-size:15px; color:#374151; margin:0 0 16px;">
                                Sua conta foi criada com sucesso no sistema <strong>{{ config('app.name') }}</strong>.
                            </p>

                            <p style="font-size:14px; color:#4b5563; line-height:1.6; margin:0 0 20px;">
                                Abaixo estão as informações de acesso iniciais. Recomendamos alterar sua senha após o primeiro login.
                            </p>
                            ...
                            <p style="font-size:13px; color:#6b7280; line-height:1.5;">
                                Se você não solicitou essa conta, entre em contato com o suporte imediatamente.
                            </p>
                        </td>
                    </tr>
