                    ...
                    <tr>
                        <td style="padding:32px 40px;">
                            ...
                            <p style="font-size:14px; color:#4b5563; line-height:1.6; margin:0 0 20px;">
                                Vimos que você redefiniu a senha do sistema <strong>{{ config('app.name') }}</strong>, caso você não tenha realizado essa ação acesse o sistema ou entre em contato com o suporte
                            </p>
