...
<select name="{{ $name }}" {{ $attributes->merge([
        'class' => 'w-full rounded-md border p-2.5 text-xs shadow-sm transition-all duration-200 disabled:bg-gray-300 disabled:text-gray-700 disabled:cursor-not-allowed ' . ($errors->has($name) && $disabled === false
