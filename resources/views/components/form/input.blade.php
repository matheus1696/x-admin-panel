...
<input
    ...
    {{ $attributes->merge([
        'class' =>
            'w-full rounded-md border px-2.5 py-2 text-xs shadow-sm transition-all duration-200 disabled:bg-gray-300 disabled:text-gray-700 disabled:cursor-not-allowed ' .
