...
@php
    $baseClasses = 'w-full rounded-md border px-2.5 py-1.5 text-[13px] shadow-sm transition-all duration-200 disabled:bg-gray-300 disabled:text-gray-700 disabled:cursor-not-allowed resize-none';
