<div>
    <x-page.header :title="__('assets.reports.transfers_by_period.title')" :subtitle="__('assets.reports.transfers_by_period.subtitle')" icon="fa-solid fa-right-left" color="blue">
        <x-slot name="button">
    ...
    <x-page.table :empty-message="__('assets.reports.empty')">
        <x-slot name="thead">
            <tr>
                <x-page.table-th :value="__('assets.reports.transfers_by_period.table.date')" />
                <x-page.table-th class="text-center" :value="__('assets.reports.transfers_by_period.table.total')" />
            </tr>
        </x-slot>
        <x-slot name="tbody">
