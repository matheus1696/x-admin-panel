            ...
            @foreach ($establishmentTypes as $establishmentType)
                <tr>
                    ...
                    <x-page.table-td class="text-center">
                        <div class="text-xs font-medium rounded-full py-0.5 px-1 {{ $establishmentType->is_active ? 'bg-green-300 text-green-700' : 'bg-red-300 text-red-700' }}">
                            {{ $establishmentType->is_active ? 'Ativo' : 'Desativado' }}
                        </div>
                    </x-page.table-td>
                </tr>
            @endforeach
