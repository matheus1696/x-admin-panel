                ...
                <section class="p-6 bg-white/30" x-data="{ showDatePicker: false }">
                    ...
                    <div class="grid grid-col-1 gap-4 mt-6 pt-4 border-t border-gray-100/80">
                        @foreach ($task->taskActivities as $taskActivity)
                            ...
                            @else 
                                @php
                                    $eventTone = match ($taskActivity->type) {
                                        'step_finished_change' => 'bg-emerald-50 text-emerald-700 border-emerald-200',
                                        'step_cancellation_change' => 'bg-rose-50 text-rose-700 border-rose-200',
                                        'step_reopen_change' => 'bg-amber-50 text-amber-700 border-amber-200',
